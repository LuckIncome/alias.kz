...
class SocialNetworksEditLayot extends Rows
{
    /**
    ...
    protected function fields(): array
    {
        return [
            ...
            Input::make('elements.link')
                ->type('text')
                ->required()
                ->title(__('platform.link'))
                ->placeholder(__('platform.link')),

            Input::make('elements.image')
                ->type('text')
                ->required()
                ->title(__('platform.image'))
                ->placeholder(__('platform.image')),
